...
public class ServiceProducerTest
{
   ...
   public static AddonArchive getDeployment()
   {
      AddonArchive archive = ShrinkWrap.create(AddonArchive.class)
               ...
               .addAsServiceProvider(Service.class, ServiceProducerTest.class, SimpleSingletonInstanceProducer.class);
   ...
   public void testProducerLookup()
   {
      ...
      Assert.assertNotEquals(service1.getRandomInteger(), service2.getRandomInteger());
